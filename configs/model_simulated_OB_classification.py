...
if __name__ == '__main__':
    ...
    for h in range(0, 5):
        ...
        data = "simulated"                          # options: "FI2010", "AAL",  "simulated"
        data_dir = "data/model/simulated_orderbooks"
        task = "classification"
        multihorizon = False                        # options: True, False
        decoder = "NA"                              # options: "seq2seq", "attention"
        ...
        checkpoint_filepath = './model_weights/deepLOB_weights_simulated/weights' + str(orderbook_updates[h])
        load_weights = False
        load_weights_filepath = './model_weights/deepLOB_weights_simulated/weights' + str(orderbook_updates[h])
    ...
    for dec in decoders:
        ...
        checkpoint_filepath = './model_weights/deepLOB_weights_simulated/weights' + dec
        load_weights = False
        load_weights_filepath = './model_weights/deepLOB_weights_simulated/weights' + dec
