...
if __name__ == '__main__':
    ...
    for h in range(0, 5):
        ...
        data_dir = "data/model/AAL_volumes_W1"
        task = "classification"
        ...
        checkpoint_filepath = './model_weights/deepVOL_weights_AAL_W1/weights' + str(orderbook_updates[h])
        load_weights = False
        load_weights_filepath = './model_weights/deepVOL_weights_AAL_W1/weights' + str(orderbook_updates[h])
    ...
    for dec in decoders:
        ...
        checkpoint_filepath = './model_weights/deepVOL_weights_AAL_W1/weights' + dec
        load_weights = False
        load_weights_filepath = './model_weights/deepVOL_weights_AAL_W1/weights' + dec
