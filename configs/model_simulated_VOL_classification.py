...
if __name__ == '__main__':
    ...
    for h in range(0, 5):
        ...
        data_dir = "data/model/simulated_volumes"
        task = "classification"
        ...
        checkpoint_filepath = './model_weights/deepVOL_weights_simulated/weights' + str(orderbook_updates[h])
        load_weights = False
        load_weights_filepath = './model_weights/deepVOL_weights_simulated/weights' + str(orderbook_updates[h])
    ...
    for dec in decoders:
        ...
        checkpoint_filepath = './model_weights/deepVOL_weights_simulated/weights' + dec
        load_weights = False
        load_weights_filepath = './model_weights/deepVOL_weights_simulated/weights' + dec
