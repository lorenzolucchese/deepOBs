...
if __name__ == '__main__':
    ...
    for h in range(0, 5):
        ...
        data = "FI2010"                             # options: "FI2010", "AAL"
        data_dir = "data/model/FI2010"
        task = "classification"
        ...
        epochs = 50
        batch_size = 32                             # note we use 256 for LOBSTER, 32 for FI2010
        number_of_lstm = 64

        checkpoint_filepath = './model_weights/deepLOB_weights_FI2010/weights' + str(orderbook_updates[h])
        load_weights = False
        load_weights_filepath = './model_weights/deepLOB_weights_FI2010/weights' + str(orderbook_updates[h])
